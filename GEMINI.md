...
9. [x] **Sub-aba Pedidos Abertos no Módulo Vendedores (`protheus_db.js`, `server.js`, `public/index.html`, `public/app.js`, `test_pedidos_abertos.js`):**
   ...
   - **Filtros Dinâmicos e UX:** Filtros reativos por Empresa (`MP`, `GSI`, `OACO`) e Vendedor (`Figueiredo`, `Andrea`, `Juliana`), badges de status em alto contraste e suíte de testes com 17 asserções automatizadas.
